...
import br.com.listadecompras.zxing.ResultMetadataType;
import br.com.listadecompras.zxing.ResultPoint;
import br.com.listadecompras.zxing.client.android.camera.CameraManager;
import br.com.listadecompras.zxing.client.android.clipboard.ClipboardInterface;
import br.com.listadecompras.zxing.client.android.history.HistoryActivity;
import br.com.listadecompras.zxing.client.android.history.HistoryItem;
import br.com.listadecompras.zxing.client.android.history.HistoryManager;
import br.com.listadecompras.zxing.client.android.result.ResultButtonListener;
import br.com.listadecompras.zxing.client.android.result.ResultHandler;
import br.com.listadecompras.zxing.client.android.result.ResultHandlerFactory;
import br.com.listadecompras.zxing.client.android.result.supplement.SupplementalInfoRetriever;
import br.com.listadecompras.zxing.client.android.share.ShareActivity;
...
//          handleDecodeInternally(rawResult, resultHandler, barcode);
                    codigoDecodificado(rawResult, resultHandler);
                }
                break;
        }
    }

    private void codigoDecodificado(Result rawResult, ResultHandler resultHandler) {
//    Intent intent = new Intent(CaptureActivity.this, ProdutoActivity.class);
...
//    bundle.putString("formato", formato);
//    bundle.putString("tipo", tipo);
//    bundle.putString("dataLeitura", dataLeitura);
//
