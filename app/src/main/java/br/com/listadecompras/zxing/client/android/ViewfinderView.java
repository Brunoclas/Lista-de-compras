...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        maskColor = resources.getColor(R.color.colorBorderScanner);
        resultColor = resources.getColor(R.color.result_view);
        laserColor = resources.getColor(R.color.colorPrimaryDark);
    ...
    public void onDraw(Canvas canvas) {
        ...
        int width = canvas.getWidth();  // Largura
        int height = canvas.getHeight();  // Altura
...
//        canvas.drawRect(0, frame.bottom + 1, width, height, paint);
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawRect(frame.left - metricaX, middle - 1, frame.right + metricaX, middle + 2, paint);
